    ...
    class Program
    {
        ...
        private static void stats(int mode1, int mode2, int mode3, int mode4, int mode5)
        {
            try
            {
                ...
                string[] messages = { "Parties jouées en mode Facile", "Parties jouées en mode Intermédiaire", "Parties jouées en mode Difficile", "Parties jouées en mode personnalisé", "Parties jouées en mode aléatoire", "Total de parties jouées", "Nombres magiques trouvés", "Victoires", "Défaites", "Abandons" };
                int[] values = { mode1, mode2, mode3, mode4, mode5, total, magics, winnes, looses, cancels };
